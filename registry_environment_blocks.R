...
# city. 11 indicators over 51,417 blocks (Addis Ababa, Jakarta, Lagos).
...
REGISTRY_ENVIRONMENT_BLOCKS <- tribble(
  ...
  "building_height_mean", "Mean building height (m)", "envblk_built", "continuous", NA, "building_height_mean", "GEE: GOOGLE/Research/open-buildings-temporal/v1, 2023, 0.5m", "Mean height of buildings in the block, averaged over building pixels only so open ground does not drag it toward zero. THE ONLY VERTICAL MEASURE in either pipeline - canopy, built-up and population are all planar - and the highest within-city variance of any indicator (98%). Range 0.5-93m across blocks. Missing where a block contains no detected buildings.",
